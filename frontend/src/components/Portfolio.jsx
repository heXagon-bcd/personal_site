            ...
            <div className="flex">
              <div index={index} className="flex flex-col p-3 mb-12 border-2 rounded-md h-96 md:h-72 md:mr-3 md:w-11/12 md:flex-row font-colfax hover:border-fuchsia-300 hover:shadow-fuchsia-300 hover:shadow-md hover:bg-white/5 backdrop-blur-3xl">
                  <div className=" md:w-5/6">
                    <div href={item.url} className="flex justify-center mb-4 text-2xl text-slate-100">{item.title}  <HiOutlineLink className="ml-4"/></div>
                  ...
                  <div className="flex items-center justify-center order-first h-24 m-5 mb-4 md:w-1/6 md:m-0 md:mt-10 md:order-last"><img className="h-20" src={item.image} alt={item.title}/></div>         
              </div>
            </div>
          </a>
        ))
