...
<div className="md:flex md:justify-center">
  <div className="relative flex items-center justify-between w-screen h-auto max-w-screen-2xl">
        ...
        <div className="items-center justify-end hidden h-16 text-sm md:mr-16 md:flex md:flex-row font-spaceMono">
        {navigation.map((item) => (
        <Link
        key={item.section}
        to={item.section}
