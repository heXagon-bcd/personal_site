...
function App() {
  ...
  return (
    <>
      <div className="text-white px-40 h-screen">
        <p className="font-spaceMono text-fuchsia-300 mt-60 mb-8">Hello My Name Is</p>
        ...
        <p className="font-colfax text-slate-400">I am  the founder of <span className="text-fuchsia-300">Black Compass Digital</span> and Lead Developer.  I develop websites and help brands make scale to the millions</p>
      </div>
      <div className=" text-slate-100 px-40 text-3xl font-medium">
        <h1>About Me</h1>
        ...
        <div className= "text-slate-100 text-xl font-medium">
        Tech Stack
        </div>
      </div>
    </>
